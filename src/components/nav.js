                    ...
                    <div className=" row d-flex justify-content-between ">
                        ...
                        <div className="col-lg-6 col-md-8 col-sm-12 p-0 m-0">
                            <ul className=" d-flex justify-content-around align-items-center  h-100 list-unstyled ">
                                ...
                                <li className="" style={{ "cursor": "pointer", "color": "#8A8888", "font-weight": "bold" }}>03219802018</li>
                                ...
                                <li className=" rounded" style={{ "color": "#8A8888", "font-weight": "bold", "cursor": "pointer" }}>Gouhar Fayyaz</li>
